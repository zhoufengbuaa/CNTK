...
def test_language_understanding(device_id):
    ...
    from _cntk_py import set_computation_network_trace_level, set_fixed_random_seed, force_deterministic_algorithms, disable_forward_values_sharing
    #set_computation_network_trace_level(1)
    set_fixed_random_seed(42) # to become invariant to initialization order, which is a valid change
    # BUGBUG: This ^^ currently seems to have no impact; the two BN models below should be identical in training
    force_deterministic_algorithms()
    disable_forward_values_sharing() # TODO remove this, once it works with fw value sharing
    ...
    if device_id >= 0: # sparse FSAdagrad currently does not run on CPU  --TODO: fix this test once it does
        ...
        expected_avg = [0.12253172994140028, 0.638837521014027] # TODO
