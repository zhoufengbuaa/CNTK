...
from cntk.learners import adam, fsadagrad, learning_rate_schedule, momentum_as_time_constant_schedule, UnitType
...
def train(reader, model, max_epochs):
    ...
    # SGD parameters
    learner = adam(criterion.parameters,
                        lr         = learning_rate_schedule([0.0015]*2+[0.00007]*12+[0.0002], UnitType.sample, epoch_size),
