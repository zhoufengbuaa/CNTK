...
def classification_error(output_vector, target_vector, axis=-1, topN=1, name=''):
    ...
    Args:
        ...
        topN (int): Indicates that the error is reported as the target label not being within the ``topN``
         predictions of the model. Its value must be a positive number greater or equal than 1.
        name (str, optional): the name of the Function instance in the network
    Returns:
        :class:`~cntk.ops.functions.Function`
    '''
